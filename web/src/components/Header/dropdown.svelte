...
{#if open}
	<aside class="bg-background dark:bg-background-dark absolute z-10 h-screen w-full overflow-hidden">
		<nav
		...
		>
			{#each routes as route, i}
				<a
					...
					class="border-gray-11 mt-4 border-b-2 pb-4 text-xl font-semibold"
					href={route.link}
